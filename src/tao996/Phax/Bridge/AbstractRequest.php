...
abstract class AbstractRequest extends AbstractInjectionAware implements RequestInterface, RequestMethodInterface
{
    /**
     ...
     * @var array
     */
    public array $combinedRequest;

    public array $postData = [];
    public array $queryData = [];
    public array $cookieData = [];
    public array $headersData = [];
    ...
    abstract public function getClientAddress(bool $trustForwardedHeader = false): bool|string;
    ...
    public function getJsonRawBody(bool $associative = false): array|bool|\stdClass
    {
        ...
        if (!is_string($rawBody) || empty($rawBody)) {
            return false;
        }
    ...
    {
        return $this->getServer('server_port') ?: 80;
    }
    ...
    abstract public function getServer(string $name): ?string;
    ...
    public function getUploadedFiles(bool $onlySuccessful = false, bool $namedKeys = false): array
    {
        ...
        foreach ($this->getFiles() as $prefix => $input) {
    ...
    abstract public function hasHeader(string $header): bool;

    public function hasQuery(string $name): bool
    {
        return isset($this->queryData[$name]);
    }
    ...
    abstract public function hasServer(string $name): bool;
    ...
    abstract public function getServerArray(): array;
